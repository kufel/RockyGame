...
public class MainMenuScreen implements Screen {
	...
	private TextButton buttonPlay = new TextButton("Play", skin),
			...
			buttonExit = new TextButton("Quit Game", skin);

    private Label title = new Label("Rocky Game",skin);
    ...
    public void show() {
        ...
        table.add(buttonHighScore).size(150,60).padBottom(20).row();
        table.add(buttonSetting).size(150,60).padBottom(20).row();
